...
- v0.7.17-beta: Correção de visibilidade de atribuições no Dashboard (suporte a `assigned_to` e `assignedTo`) e permissão de leitura de perfis para Publicadores.
